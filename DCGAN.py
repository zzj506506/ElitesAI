...
# alphas = [0, 0.2, 0.4, .6]
# x = np.arange(-2, 1, 0.1)
# Y = [nn.LeakyReLU(alpha)(Tensor(x)).numpy() for alpha in alphas]
...
if __name__ == '__main__':
    ...
    lr_D,lr_G,latent_dim,num_epochs=0.005,0.005,100,5
    train(discriminator,generator,data_iter,num_epochs,lr_D,lr_G,latent_dim)